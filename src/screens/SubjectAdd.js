...
import { faCalendar, faChevronDown, faTimesCircle } from '@fortawesome/free-solid-svg-icons';
...
const availableOptions = ["Predicted","Actual"];

export default SubjectAdd = props => {
  ...
  const addSubject =  () => {
    props.navigation.navigate('EditProfile', { newSubject: {
        ...
        <View style={{paddingBottom:responsiveHeight(10), paddingTop:responsiveHeight(4),}}>
          ...
          <View style={{marginTop: responsiveHeight(3),}}>
              ...
              <TouchableOpacity onPress={() => subjectSheetRef.current.open()}>
                <View style={{...styles.input, paddingTop:responsiveHeight(0.5)}}>
                  {selectedSubject.length > 0 ?
                    <Text style={styles.viewInput}>{selectedSubject}</Text>
                  :
                    <Text style={styles.viewInput}>Select Subject</Text>
                  }
            ...
            {selectedSubject == 'Other' &&
              <View style={{...styles.normalInputContainer}}>
                <Text style={styles.normalInputText}>Subject Name</Text>
                <Input 
                  id="subject_name"
                  selectionColor={'#333'}
                  style={styles.input} 
              ...
              <View style={{ paddingHorizontal: responsiveHeight(2), paddingVertical: responsiveHeight(0.5) }}>
                ...
                <ScrollView style={styles.sheetScroll}>
                  ...
                  { availableSubjects.map((subject, index) => {
                    return (
                      <TouchableOpacity key={index} style={styles.singleSheetOption} onPress={() => selectSubject(subject)}>
                        <View style={styles.radioButtonPosition}>
                          <RadioButton outerCircleColor={"#222"} outerCircleSize={22} outerCircleWidth={2} innerCircleColor={'#222'} innerCircleSize={11} currentValue={selectedSubject} value={subject} onPress={() => selectSubject(subject)} />
                        </View>
                        <Text style={styles.singleSheetText}>{subject}</Text>
                      </TouchableOpacity>
                    );
                  })}
            ...
            {/* Grade */}
            <View style={{...styles.normalInputContainer}}>
              <Text style={styles.normalInputText}>Grade</Text>
              <TouchableOpacity onPress={() => gradeSheetRef.current.open()}>
                <View style={{...styles.input, paddingTop:responsiveHeight(0.5)}}>
                  {selectedGrade.length > 0 ?
                    <Text style={styles.viewInput}>{selectedGrade}</Text>
                  :
                    <Text style={styles.viewInput}>Select Grade</Text>
                  }
                  <Image style={{...styles.inputIcon,transform: [{ rotate: '-90deg'}]}} source={require('../../assets/images/ypa/new-images/left-arrow-black.png')} />
                </View>
              </TouchableOpacity>
              ...
              <View style={{ paddingHorizontal: responsiveHeight(2), paddingVertical: responsiveHeight(0.5) }}>
                ...
                <ScrollView style={styles.sheetScroll}>
                  { availableGrades.map((grade, index) => {
                    return (
                      <TouchableOpacity key={index} style={styles.singleSheetOption} onPress={() => selectGrade(grade)}>
                        <View style={styles.radioButtonPosition}>
                          <RadioButton outerCircleColor={"#222"} outerCircleSize={22} outerCircleWidth={2} innerCircleColor={'#222'} innerCircleSize={11} currentValue={selectedGrade} value={grade} onPress={() => selectGrade(grade)} />
                        </View>
                        <Text style={styles.singleSheetText}>{grade}</Text>
                      </TouchableOpacity>
                    );
                  })}
            ...
            {/* Grade */}
            <View style={{...styles.normalInputContainer}}>
              <Text style={styles.normalInputText}>Predicted / Actual</Text>
              <TouchableOpacity onPress={() => typeSheetRef.current.open()}>
                <View style={{...styles.input, paddingTop:responsiveHeight(0.5)}}>
                  {selectedOption.length > 0 ?
                    <Text style={styles.viewInput}>{selectedOption}</Text>
                  :
                    <Text style={styles.viewInput}>Select Predicted / Actual</Text>
                  }
                  <Image style={{...styles.inputIcon,transform: [{ rotate: '-90deg'}]}} source={require('../../assets/images/ypa/new-images/left-arrow-black.png')} />
                </View>
              </TouchableOpacity>
            ...
            >
              <View style={{ paddingHorizontal: responsiveHeight(2), paddingVertical: responsiveHeight(0.5) }}>
                <View style={styles.sheetTitleContainer}>
                  <Text style={styles.sheetTitle}>Select Predicted / Actual</Text>
                </View>
                <ScrollView style={styles.sheetScroll}>

                  { availableOptions.map((option, index) => {
                    return (
                      <TouchableOpacity key={index} style={styles.singleSheetOption} onPress={() => selectOption(option)}>
                        <View style={styles.radioButtonPosition}>
                          <RadioButton outerCircleColor={"#222"} outerCircleSize={22} outerCircleWidth={2} innerCircleColor={'#222'} innerCircleSize={11} currentValue={selectedOption} value={option} onPress={() => setSelectedOption(option)} />
                        </View>
                        <Text style={styles.singleSheetText}>{option}</Text>
                      </TouchableOpacity>
                    );
                  })}
            ...
            <View style={styles.bottomButtonArea}>
              <TouchableOpacity style={{opacity: (selectedSubject.length > 0 && selectedGrade.length > 0 && selectedOption.length > 0 ? 1 : 0.5 )}} disabled={!(selectedSubject.length > 0 && selectedGrade.length > 0 && selectedOption.length > 0)} onPress={() => addSubject()}>
                <LinearGradient colors={['#3895fc', '#005ba6']} style={styles.solidButtonPrimary} start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }}>
                  <Text style={styles.solidButtonPrimaryText}>Add Subject</Text>
                </LinearGradient>
              </TouchableOpacity>
            </View>
